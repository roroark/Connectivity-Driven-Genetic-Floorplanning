...
public:
	...
	MaxRectsBinPack(double width, double height, bool allowFlip = false);

	/// (Re)initializes the packer to an empty bin of width x height units. Call whenever
	/// you need to restart with a new bin.
	void Init(double width, double height, bool allowFlip = false);
	...
	Rect Insert(double width, double height, FreeRectChoiceHeuristic method = RectBestShortSideFit);
